...
import ThirdStep from "../Add/ThirdStep";
...
class DesignAddStep3 extends Component {
  logout() {
    this.props.logout();
    ...
    return (
      ...
      <div id="right-panel" class="right-panel">
        <header id="header" class="header">
          ...
          <ThirdStep  id={this.props.match.params.id} history={this.props.history}/>
        </div>
      </body>
    );
  }
}
DesignAddStep3.propTypes = {
